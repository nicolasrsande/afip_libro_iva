module AfipLibroIva
  ...
  class ComprobanteCompra < Fixy::Record
    ...
    field :despacho_importacion ,     16,     '37-52',      :numeric
    ...
    def initialize(comprobante)
      ...
      @despacho_importacion = comprobante[:despacho_importacion]
      @cod_documento_vendedor = comprobante[:tipo_documento]
      ...
      @credito_fiscal_computable = comprobante[:credito_fiscal_computable] || "O"
